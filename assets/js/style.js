((global, factory) => {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('jquery')) :
    typeof define === 'function' && define.amd ? define(['exports', 'jquery'], factory) :
      (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.adminwpb = {}, global.jQuery));
})(this, ((exports, $) => {
  'use strict'
  ...
  /* 
  AdminWPB CardRefreshF
  */

  var NAME$e = 'CardRefresh';
  var DATA_KEY$e = 'wpb.cardrefresh';
  ...
  var DATA_KEY$c = 'wpb.controlsidebar';
  ...
  var DATA_KEY$9 = 'wpb.expandableTable';
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    IFrame._jQueryInterface = function _jQueryInterface(config) {
      if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
        ...
        localStorage.setItem('AdminWPB:IFrame:Options', JSON.stringify(_options));
        ...
        new IFrame($__default["default"](this), JSON.parse(localStorage.getItem('AdminWPB:IFrame:Options')))._initFrameElement();
      }
    };
  ...
  var Layout = /*#__PURE__*/function () {
    ...
    _proto._init = function _init() {
      ...
      $__default["default"](SELECTOR_SIDEBAR$1).on('collapsed.wpb.treeview expanded.wpb.treeview', function () {
      ...
      $__default["default"](SELECTOR_PUSHMENU_BTN).on('collapsed.wpb.pushmenu shown.wpb.pushmenu', function () {
        setTimeout(function () {
          _this.fixLayoutHeight();
        }, 300);
      });
      $__default["default"](SELECTOR_CONTROL_SIDEBAR_BTN).on('collapsed.wpb.controlsidebar', function () {
        _this.fixLayoutHeight();
      }).on('expanded.wpb.controlsidebar', function () {
  ...
  var DATA_KEY$4 = 'wpb.sidebar-search';
  ...
  var DATA_KEY$3 = 'wpb.navbar-search';
